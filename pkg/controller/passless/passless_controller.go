...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcilePassLess{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner PassLess
...
func (r *ReconcilePassLess) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &wavesoftwarev1alpha1.PassLess{}
...
func newPodForCR(cr *wavesoftwarev1alpha1.PassLess) *corev1.Pod {
